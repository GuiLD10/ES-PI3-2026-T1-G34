...
export function montarStartup(
  ...
  return {
    ...
    mentores_conselho: Array.isArray(dados.mentores_conselho) ?
      dados.mentores_conselho :
      [],
    perguntas_respostas: Array.isArray(dados.perguntas_respostas) ?
